...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference("Director.count") do
      post directors_url, params: { director: { firstName: @director.firstName, lastName: @director.lastName, store_id: @director.store_id } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { firstName: @director.firstName, lastName: @director.lastName, store_id: @director.store_id } }

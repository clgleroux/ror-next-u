class TrucsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @truc.save
        format.html { redirect_to truc_url(I18n.locale, @truc), notice: "Truc was successfully created." }
  ...
  def update
    respond_to do |format|
      if @truc.update(truc_params)
        format.html { redirect_to truc_url(I18n.locale, @truc), notice: "Truc was successfully updated." }
